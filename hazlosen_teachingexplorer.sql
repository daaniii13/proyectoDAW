...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-04-2026 a las 14:50:55
...
(23, 'Lasaña de Carne: El Truco del Reposo para que el Corte no se Desmonte', 'La lasaña casera de carne es, sin duda, uno de los platos más reconfortantes y queridos de la cocina italiana. Capas de pasta tierna, un relleno de carne picada jugosa con tomate y una capa generosa de bechamel cremosa se unen para crear un bocado irresistible que gusta a todo el mundo.', 'Inicial', 'Online', '1\'5 horas', 2.00, 'activo', '2026-04-17 12:56:28', 30, 'https://bestcdn.dev/uploads/16/2026/03/lasa--a-casera-69b81a58eb37a.webp', NULL),
(24, 'Rutina de empuje', 'Descubre cómo entrenar pecho, hombros y tríceps de forma estratégica para ganar fuerza y volumen, maximizando cada repetición y logrando un desarrollo equilibrado.', 'Intermedio', 'Online', '1 semana', 5.00, 'activo', '2026-04-17 13:38:10', 51, NULL, NULL),
(25, 'Rutina de tirón', 'Aprende a trabajar espalda y bíceps con una estructura eficaz que mejora tu postura, aumenta tu fuerza y construye una espalda más ancha y definida.', 'Intermedio', 'Online', '1 semana', 5.00, 'activo', '2026-04-17 13:38:45', 51, NULL, NULL),
(26, 'Rutina de espalda', 'Un enfoque específico para desarrollar una espalda poderosa: más amplitud, más grosor y mejor conexión muscular en cada ejercicio.', 'Intermedio', 'Online', '1 semana', 5.00, 'activo', '2026-04-17 13:39:30', 51, NULL, NULL),
(27, 'Cómo posar en el espejo', 'Porque no basta con entrenar, hay que saber mostrarlo. Aprende a posar correctamente para evaluar tu progreso y resaltar al máximo tu físico.', 'Intermedio', 'Presencial', '1 día', 45.00, 'activo', '2026-04-17 13:40:29', 51, NULL, NULL),
(28, 'La alimentación para el aumento de masa muscular', 'Optimiza tus resultados con una guía práctica de nutrición enfocada en ganar músculo, mejorando tu rendimiento y acelerando tu progreso.', 'Intermedio', 'Online', '1 semana', 10.00, 'activo', '2026-04-17 13:41:13', 51, NULL, NULL),
(29, 'Las fases de definición y volumen, ¿como funcionan?', 'Aprende a diferenciar y aplicar correctamente las fases de definición y volumen para maximizar tus resultados, evitando errores comunes y optimizando tu progreso durante todo el año.', 'Intermedio', 'Online', '1 semana', 10.00, 'activo', '2026-04-17 13:45:08', 51, NULL, NULL),
(30, 'Guitarra acústica desde cero', 'Aprende los acordes básicos, ritmos y canciones sencillas para empezar a tocar la guitarra desde el primer día.', 'Inicial', 'Online', '6 semanas', 49.00, 'activo', '2026-04-17 13:46:19', 42, NULL, NULL),
(31, 'Guía completa: Desde cero hasta un físico impresionante', 'Un sistema paso a paso diseñado para transformar tu cuerpo desde el inicio, combinando entrenamiento, técnica y nutrición para lograr un cambio real y duradero.', 'Intermedio', 'Mixto', '1 mes', 80.00, 'activo', '2026-04-17 13:46:26', 51, NULL, NULL),
(32, 'Piano moderno para principiantes', 'Curso práctico para iniciarte en el piano con canciones actuales, lectura básica de partituras y técnica de manos.', 'Inicial', 'Online', '8 semanas', 65.00, 'activo', '2026-04-17 13:47:01', 42, NULL, NULL),
(33, 'Batería: ritmo y coordinación', 'Mejora tu coordinación y aprende patrones rítmicos esenciales para tocar batería en distintos estilos musicales.', 'Intermedio', 'Online', '5 semanas', 54.99, 'activo', '2026-04-17 13:47:35', 42, NULL, NULL),
(34, 'Violín clásico básico', 'Introducción al violín con enfoque en postura, afinación y primeras piezas clásicas.', 'Inicial', 'Online', '10 semanas', 80.00, 'activo', '2026-04-17 13:48:26', 42, NULL, NULL),
(35, 'Bajo eléctrico groove y técnica', 'Aprende líneas de bajo, técnica de dedos y slap para tocar funk, rock y pop.', 'Intermedio', 'Mixto', '7 semanas', 60.00, 'activo', '2026-04-17 13:49:52', 42, NULL, NULL),
(36, 'Ukelele fácil y divertido', 'Curso rápido para aprender acordes básicos y tocar canciones populares con ukelele.', 'Inicial', 'Online', '4 semanas', 35.00, 'activo', '2026-04-17 13:50:48', 42, NULL, NULL),
(37, 'Saxofón: Iniciación al jazz', 'Descubre el saxofón con enfoque en improvisación básica y escalas de jazz.', 'Intermedio', 'Online', '9 semanas', 75.00, 'activo', '2026-04-17 13:51:33', 42, NULL, NULL),
(38, 'Flauta travesera desde cero', 'Aprende respiración, digitación y primeras melodías con flauta travesera.', 'Inicial', 'Online', '6 semanas', 50.00, 'activo', '2026-04-17 13:52:12', 42, NULL, NULL),
(39, 'Producción musical con teclado MIDI', 'Combina el uso del teclado con software para crear tus propias composiciones.', 'Intermedio', 'Online', '5 semanas', 70.00, 'activo', '2026-04-17 13:52:49', 42, NULL, NULL),
(40, 'Cajón flamenco: Ritmo y técnica', 'Aprende los golpes básicos y ritmos flamencos para acompañar música en directo.', 'Inicial', 'Online', '3 semanas', 30.00, 'activo', '2026-04-17 13:53:29', 42, NULL, NULL),
(41, 'Diseño UX/UI', 'Especialización en prototipado de alta fidelidad y sistemas de diseño complejos.', 'Avanzado', 'Online', '80h', 400.00, 'activo', '2026-04-17 13:54:49', 61, 'https://th.bing.com/th/id/OIP.UzeQeUT3AdMN5i-LWAVaCQHaE6?w=223&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7', NULL),
(42, 'Guitarra eléctrica: Solos y técnicas avanzadas', 'Domina técnicas como sweep picking, tapping y bending avanzado para desarrollar solos complejos en distintos estilos.', 'Avanzado', 'Presencial', '10 semanas', 95.00, 'activo', '2026-04-17 13:55:32', 42, NULL, NULL),
(43, 'Piano jazz e improvisación profesional', 'Aprende armonía avanzada, improvisación y reharmonización para tocar jazz a nivel profesional.', 'Avanzado', 'Presencial', '12 semanas', 110.00, 'activo', '2026-04-17 13:56:08', 42, NULL, NULL),
(44, 'Batería avanzada: Polirritmia y velocidad', 'Perfecciona tu técnica con ejercicios de independencia, polirritmia y control de velocidad en batería.', 'Avanzado', 'Presencial', '8 semanas', 90.00, 'activo', '2026-04-17 13:57:00', 42, NULL, NULL),
(45, 'SEO y SEM Estratégico', 'Posicionamiento en buscadores y gestión de campañas en Google Ads.', 'Avanzado', 'Online', '60h', 300.00, 'activo', '2026-04-17 13:58:00', 61, NULL, NULL),
(46, 'Violín: Interpretación y técnica superior', 'Mejora tu expresividad, vibrato, cambios de posición y ejecución de piezas complejas del repertorio clásico.', 'Avanzado', 'Presencial', '12 semanas', 120.00, 'activo', '2026-04-17 13:58:27', 42, NULL, NULL),
(47, 'Bajo eléctrico avanzado: Improvisación y slap', 'Desarrolla tu creatividad con técnicas avanzadas de slap, tapping y escalas para improvisar en directo.', 'Avanzado', 'Presencial', '9 semanas', 85.00, 'activo', '2026-04-17 13:59:25', 42, NULL, NULL),
(48, 'Inglés de Negocios (B2-C1)', 'Perfeccionamiento de la comunicación en entornos corporativos internacionales.', 'Avanzado', 'Online', '100h', 500.00, 'activo', '2026-04-17 14:01:32', 61, NULL, NULL),
(49, 'Iniciación al baloncesto', 'Aprende los fundamentos esenciales del baloncesto: manejo de balón, tiro, pases y movimientos básicos para empezar a jugar con confianza desde el primer día.', 'Inicial', 'Mixto', '1 mes', 69.99, 'activo', '2026-04-17 14:01:50', 51, NULL, NULL),
(50, 'Iniciación al volleyball', 'Descubre las bases del volleyball, desde los saques y recepciones hasta la colocación y el remate, desarrollando coordinación y juego en equipo.', 'Inicial', 'Mixto', '1 mes', 69.99, 'activo', '2026-04-17 14:02:23', 51, NULL, NULL),
(51, 'Iniciación al tennis', 'Empieza en el tenis dominando los golpes básicos, el saque y el desplazamiento en pista, construyendo una técnica sólida desde cero.', 'Inicial', 'Online', '1 mes', 39.99, 'activo', '2026-04-17 14:03:36', 51, NULL, NULL),
(52, 'Baile moderno: Fundamentos y coreografías', 'Aprende pasos básicos de baile moderno y combínalos en coreografías dinámicas y actuales.', 'Inicial', 'Presencial', '6 semanas', 45.00, 'activo', '2026-04-17 14:03:44', 42, NULL, NULL),
(53, 'Iniciación a la natación', 'Mejora tu técnica en el agua aprendiendo los estilos principales, la respiración correcta y la coordinación para nadar con eficiencia y seguridad.', 'Inicial', 'Online', '1 mes', 39.99, 'activo', '2026-04-17 14:04:15', 51, NULL, NULL),
(54, 'Salsa: De cero a intermedio', 'Iníciate en la salsa y avanza hasta combinaciones de giros y pasos en pareja con soltura.', 'Inicial', 'Mixto', '8 semanas', 60.00, 'activo', '2026-04-17 14:04:21', 42, NULL, NULL),
(55, 'Iniciación al ajedrez', 'Adéntrate en el ajedrez comprendiendo las reglas, las piezas y las primeras estrategias para desarrollar tu pensamiento y tomar mejores decisiones en cada partida.', 'Inicial', 'Online', '1 mes', 50.00, 'activo', '2026-04-17 14:04:44', 51, NULL, NULL),
(56, 'Hip Hop freestyle y técnica', 'Mejora tu estilo en hip hop aprendiendo bases, grooves y técnicas de improvisación.', 'Intermedio', 'Online', '7 semanas', 55.00, 'activo', '2026-04-17 14:05:10', 42, NULL, NULL),
(57, 'Bachata avanzada', 'Perfecciona tu técnica, conexión en pareja y movimientos fluidos en bachata.', 'Avanzado', 'Presencial', '6 semanas', 70.00, 'activo', '2026-04-17 14:05:47', 42, NULL, NULL),
(58, 'Danza contemporánea: Expresión y técnica', 'Explora el movimiento corporal, la expresividad y técnicas avanzadas de danza contemporánea.', 'Avanzado', 'Mixto', '9 semanas', 80.00, 'activo', '2026-04-17 14:06:43', 42, NULL, NULL),
(59, 'Marketing Digital 360', 'Estrategias de SEO, SEM, redes sociales y analítica de datos para negocios modernos', 'Inicial', 'Online', '40 horas', 150.00, 'activo', '2026-04-17 14:14:47', 61, 'https://th.bing.com/th/id/OIP.Lx6KZUsW-7gFZIs5dqFI5QHaHa?w=173&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7', NULL),
(60, 'Finanzas Personales e Inversión', 'Aprende a gestionar tu capital, crear presupuestos y entender el mercado de valores básico.', 'Inicial', 'Online', '25 horas', 100.00, 'activo', '2026-04-17 14:16:52', 61, 'https://contabilidadfinanzas.com/wp-content/uploads/2023/08/finanzas-responsables.jpg', NULL),
(61, 'Dominio de Python para IA', 'Aprende las bases de programación y cómo aplicarlas en modelos de Inteligencia Artificial.', 'Intermedio', 'Online', '60 horas', 200.00, 'activo', '2026-04-17 14:23:33', 61, 'https://www.nethues.com/blog/app/uploads/2023/06/artificial-intelligence-with-python-2.png', NULL),
(62, 'Excel Avanzado, Power BI y Python', 'Domina tablas dinámicas, macros y visualización de datos profesional.', 'Avanzado', 'Online', '35 horas', 300.00, 'activo', '2026-04-17 14:27:22', 61, 'https://mentory.pe/wp-content/uploads/2025/10/Excel-Avanzado-Power-BI-y-Python.jpg', NULL),
(63, 'Ciberseguridad Esencial', 'Protege datos y redes. Introducción al hacking ético y protocolos de seguridad.', 'Inicial', 'Online', '45 horas', 150.00, 'activo', '2026-04-17 14:31:28', 61, 'https://img.freepik.com/fotos-premium/ciberseguridad-esencial-exige-inicio-sesion-seguro-traves-teclado-computadora_892776-16040.jpg', NULL);
...
(1, 2, 28, 'entrega_69e8b0c3c70467.61817502.pdf', 'te lo entrego ahora!', '2026-04-22 13:28:03', 'aprobada', 50, 'Perfect Cristine. Great job', '2026-04-22 13:29:41');
...
(11, 50, 'activa', '2026-04-16 06:34:04', 39, 11, 'PAGO-CURSO-11-USER-39'),
(12, 0, 'activa', '2026-04-16 06:38:59', 30, 11, 'PAGO-CURSO-11-USER-30'),
...
(17, 0, 'pendiente_pago', '2026-04-22 13:15:09', 46, 18, 'PAGO-CURSO-18-USER-46');
...
(30, 63, 'pro', 'activa', 5, '2026-04-22 10:43:51', '2026-04-22 10:44:57', NULL, NULL);
...
(63, 'profeprueba@gmail.com', '[\"ROLE_ESTUDIANTE\",\"ROLE_PROFESOR\"]', '$2y$13$ohEJws4gT34uV.N3ti29WexJXK0lrWNNyRSecawlYBMPBC0v6JRkO', 'Profe prueba', '2026-04-22 10:43:51', 1, NULL),
(64, 'danonetecno13@gmail.com', '[\"ROLE_ESTUDIANTE\"]', '$2y$13$FQqBqf0SJSYCegLk/3O6nuM8aKrpdrcYOjyFULFEe0UbeEL.2hGBK', 'Danone', '2026-04-22 14:07:50', 1, NULL);
